...
const DiscoverComp = () => {
  return (
            ...
            <Link href="/decarb/discover">
               <button className="bg-[#d9e4e7] text-black px-4 py-2 rounded-md shadow-md hover:bg-[#ccdede] transition-colors duration-300 absolute right-4 bottom-4">Discover</button>
            </Link>
